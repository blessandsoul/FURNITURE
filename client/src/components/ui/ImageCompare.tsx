    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    className={cn(
                        'absolute left-1/2 top-1/2 z-20 flex h-9 w-9 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border-2 border-background bg-background shadow-lg transition-transform duration-200',
