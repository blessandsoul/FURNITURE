...
4. **Protect critical flows**: Never break existing auth, core ordering flows, or payment logic.
...
- **Commit messages**: Use conventional commits — `feat:`, `fix:`, `chore:`, `refactor:`, `docs:`, `test:`.
  ...
  - Use imperative mood: "Add product filter" not "Added product filter".
