...
- **Buttons**: Action verbs — "Save changes", "Add product", "Delete account". Never "Submit" or "OK".
- **Toasts**: Under 10 words. Success: confirm. Error: what happened + what to do.
- **Empty states**: Explain what this area is for + CTA to fill it. ("No products yet. Add your first product.")
