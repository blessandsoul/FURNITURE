...
|---|---|---|
| `primary` | Main CTAs, links, active states | "Add to Cart" button |
| `secondary` | Secondary actions | Cancel, back |
| `destructive` | Delete, errors | Delete button, error alert |
| `success` | Success states | "Order confirmed" |
| `warning` | Warnings | "Payment pending" |
| `info` | Information | "New collection" badge |
| `muted` | Disabled, placeholders | Disabled input |
| `accent` | Highlights | "50% off" badge |
| `card` | Card backgrounds | Product card |
