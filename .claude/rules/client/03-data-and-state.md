...
class ProductService {
  async getProducts(params?: ProductFilters & PaginationParams): Promise<PaginatedData<Product>>
...
|---|---|---|
| General content | `next: { revalidate: 60 }` | Products list |
| User-specific | `cache: 'no-store'` | User profile |
| Static lookups | `cache: 'force-cache'` | Materials, categories |
